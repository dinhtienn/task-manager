                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ route('manager.job') }}" class="btn btn-primary">Xem ngay</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ route('manager.punish') }}" class="btn btn-outline-danger">Xem ngay</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ route('manager.kpi') }}" class="btn btn-sm btn-outline-info">Xem ngay</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
