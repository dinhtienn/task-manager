                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted">
                                    Cử nhân hoá học - Đại học Bách Khoa Hà Nội
                                </p>
                                ...
                                <p class="text-muted">Tây Sơn, Đống Đa, Hà Nội</p>
                                    ...
                                    <div class="tab-pane active" id="settings">
                                        <form class="form-horizontal" action="#">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="inputName" placeholder="Name" value="Chu Ngọc Minh">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="inputName2" placeholder="Trình độ" value="Cử nhân hoá học - Đại học Bách Khoa Hà Nội">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputExperience" class="col-sm-2 col-form-label">Địa điểm</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" id="inputExperience" placeholder="Địa điểm" value="Tây Sơn, Đống Đa, Hà Nội">
                                                </div>
                                            </div>
                                            <div class="form-group row">
